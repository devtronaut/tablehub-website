...
const UspCard = ({ image, title, content }: UspCardProps) => {
    return (
        <div className="card dark:bg-cardDark bg-cardLight w-72 shadow-md shadow-shimmer p-0 m-0">
            <figure className="px-10 pt-10 w-1/2 m-auto">{image}</figure>
...
const UpdatedIcon = () => {
    return (
        <svg
            ...
            className="dark:fill-white fill-black hover:animate-spin"
        >
            <path
                className=""
...
const AutomatedIcon = () => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -960 960 960"
            className="dark:fill-white fill-black origin-bottom hover:animate-bounce ease-bounce"
        >
...
const EasyIcon = () => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -960 960 960"
            className="dark:fill-white fill-black origin-bottom hover:animate-wiggle"
        >
