            ...
            <div className="w-full lg:w-1/2 space-y-8 text-center">
                <div className="space-y-2">
                    ...
                    <div className="w-full">
                        <p>{t('thanks')}</p>
                        <div className="h-fit w-full mt-2 flex flex-row justify-center gap-4">
                            <ClubLogo
...
const GitHubTag = ({ projectLink, projectName }: GitHubTagProps) => {
    return (
        <a href={projectLink} target="_blank">
            <div className="h-fit w-fit flex flex-row items-center gap-3 bg-cardLight dark:bg-cardDark p-3 rounded-xl shadow-md shadow-shimmer">
                <svg
                    viewBox="0 0 98 96"
